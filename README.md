...
- [Maybe the best Go book: "The Go Programming Language"](https://www.gopl.io/)
- [Learn Go with Test](https://quii.gitbook.io/learn-go-with-tests/)
- [7 hours video of Go summary](https://www.youtube.com/watch?v=YS4e4q9oBaU)
- [Go by example](https://gobyexample.com/)
- [Gopher exercises](https://gophercises.com/)
